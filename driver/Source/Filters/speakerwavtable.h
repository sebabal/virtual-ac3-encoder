...
// Virtual AC3 Encoder sink: 48KHz, 16-bit, 5.1 (FL FR FC LFE BL BR). Windows mixes any app
// stream to this endpoint format; the engine then loopback-captures the 5.1 mix.

#define SPEAKER_DEVICE_MAX_CHANNELS                 6       // Max Channels.

#define SPEAKER_HOST_MAX_CHANNELS                   6       // Max Channels.
        ...
        {
            {
                ...
                576000,   // nAvgBytesPerSec = 48000 * 12
                12,       // nBlockAlign = 6ch * 16-bit/8
                16,       // wBitsPerSample
