...
)
{
    ...
    // Render-only virtual sink: no capture endpoints (g_cCaptureEndpoints == 0). Guarded with
    // the preprocessor so the unsigned "i < 0" comparison/label aren't emitted (C4296/C4102 + /WX).
#if g_cCaptureEndpoints > 0
